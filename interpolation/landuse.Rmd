...
Provincial layers discussed in more detail below have in all cases been re-sampled to the 50x50m² grid associated with the [hydrologically corrected DEM](https://owrc.github.io/interpolants/interpolation/overland.html). It is from these rasters where the aggregation of watershed characteristics is computed.
...
![Final 50x50m SOLRIS mapping.](https://github.com/OWRC/interpolants/blob/main/interpolation/calc/landuse/output/solrisv3_10_infilled_50.png?raw=true)
Final 50x50m SOLRIS mapping. *(For illustrative purposes only [see here](https://github.com/OWRC/interpolants/blob/main/interpolation/calc/landuse/OWRC-SWS.ipynb) to reproduce shown raster.)*
...
read.csv('calc/landuse/input/lookup_200731.csv') %>%
  select(1:2,7:8) %>%
...
![Final 50x50m impervious mapping.](https://github.com/OWRC/interpolants/blob/main/interpolation/calc/landuse/output/solrisv3_10_infilled_50_perimp.png?raw=true) *(For illustrative purposes only [see here](https://github.com/OWRC/interpolants/blob/main/interpolation/calc/landuse/OWRC-SWS.ipynb) to reproduce shown raster.)*

![Final 50x50m canopy mapping.](https://github.com/OWRC/interpolants/blob/main/interpolation/calc/landuse/output/solrisv3_10_infilled_50_percov.png?raw=true) *(For illustrative purposes only [see here](https://github.com/OWRC/interpolants/blob/main/interpolation/calc/landuse/OWRC-SWS.ipynb) to reproduce shown raster.)*
...
![Final 50x50m permeability mapping.](https://github.com/OWRC/interpolants/blob/main/interpolation/calc/landuse/output/OGSsurfGeo_50.png?raw=true)
Final 50x50m permeability mapping. *(For illustrative purposes only [see here](https://github.com/OWRC/interpolants/blob/main/interpolation/calc/landuse/OWRC-SWS.ipynb) to reproduce shown raster.)*
...
## Final shapefile
[owrc20-50a_SWS10-final.geojson (v.2020)](https://www.dropbox.com/s/ro16gg6zi4kqbc0/owrc20-50a_SWS10-final.geojson?dl=1)
